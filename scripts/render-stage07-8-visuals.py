...
OUT = ROOT / "docs" / "stage07-8-screenshots"
...
async def prepare(page) -> None:
    ...
    () => {
      ...
      document.querySelector('#organizationFilterStatus').textContent = '日本語229語。英語271語を利用可能。推奨は基本289語。上限2000語。';
      document.querySelector('#filterPackStatus').textContent = '日本語 基本128語: 導入済み v2 / 英語 基本161語: 導入済み v2 / 文脈注意: 未導入';
      ...
      document.querySelector('#installJapaneseContextFilterPackButton').disabled = false;
      document.querySelector('#installEnglishContextFilterPackButton').disabled = false;
      const categories = [
