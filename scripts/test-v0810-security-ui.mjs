...
check('student page asset versions match the 0.8.10 UI release', htmlAssetVersions.length > 0 && htmlAssetVersions.every((value) => ['0.8.10', '0.8.10-ui2', '0.8.10-ui3'].includes(value)));
