...
check("package version is Stage 8 precision release", pkg.version === "0.8.1", pkg.version);
...
check("remote verifier requires Stage 8 migrations", remoteVerifier.includes("0015_pdf_page_analytics") && remoteVerifier.includes("0016_stage08_precision_hardening"));
